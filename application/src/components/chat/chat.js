...
const getchat = 'http://192.168.0.121:5000/chat/get';


const endpoint = '192.168.0.121:5000';
let socket;
	...
	componentDidMount() {
		if (localStorage.getItem('userId') && localStorage.getItem('userAccessToken')) {
			if (this.state.chatId) {
				...
				window.location.href = 'http://192.168.0.121:3000/account';
			}
		} else {
			window.location.href = 'http://192.168.0.121:3000';
		}
	}
