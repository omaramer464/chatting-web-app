...
const loginpage = 'http://192.168.0.121:3000';
const checkURL2 = 'http://192.168.0.121:5000/account/get/refresh';
const deleteAccount = 'http://192.168.0.121:5000/account/delete';
const changeimgURL = 'http://192.168.0.121:5000/account/profileimg/change';
const loadimg = 'http://192.168.0.121:5000/account/profileimg';
const removeimg = 'http://192.168.0.121:5000/account/profileimg/remove';
const checkusername = 'http://192.168.0.121:5000/account/change/username';
const checkpassword = 'http://192.168.0.121:5000/account/change/password';
const searchURL = 'http://192.168.0.121:5000/account/search';
const getchats = 'http://192.168.0.121:5000/account/chats';
const sendRequest = 'http://192.168.0.121:5000/account/friends/sendRequest';
const cancelRequest = 'http://192.168.0.121:5000/account/friends/cancelRequest';
...
class Chating extends React.Component {
	...
	/*
		there is an error here. a delay before putting chatId and img to this.state
		try to fix it by making the request to getchats from outside of this class
		and return them as props. this may work.
	*/
